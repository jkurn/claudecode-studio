...
All quotes from the 2026-04-22 Claude Community Australia webinar.
Sorted by speaker. Suitable for social posts, newsletter pull-quotes,
and landing copy.
...
> "Taste and judgment are the two things I'm most focused on."

> "Each dot here represents 3.2 million people. The vast majority have
> never used AI. Don't stress."

> "The days of building dashboards being the thing clients are looking
> for are going to decrease."
...
> "Smaller context windows equal better accuracy. Small context wins
> all the time."
...
> "In the future everyone will have their own personal MD file. Within
> organizations, delivery will have an MD file, sales will have an MD
> file."
